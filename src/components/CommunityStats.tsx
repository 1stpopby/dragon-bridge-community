...
const CommunityStats = () => {
  ...
  const fetchStats = async () => {
    try {
      ...
      const [{ count: membersCount }, { count: eventsCount }, { count: postsCount }, { count: groupsCount }] =
        await Promise.all([
    ...
    <div className="bg-muted/30 py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-4">Creștem Împreună în Toată Europa</h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            De la un capăt la altul al lumii, comunitatea noastră aduce împreună români care se susțin, se conectează și
            cresc împreună.
          </p>
        </div>
